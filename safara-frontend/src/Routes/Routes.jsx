...
const AdminManualPayments = lazy(() =>
  import("../Pages/Dashboard/AdminDashboard/AdminManualPayments")
);
const PaymentSettings = lazy(() =>
  import("../Pages/Dashboard/AdminDashboard/PaymentSettings")
);
...
export const router = createBrowserRouter([
  ...
  // Admin Dashboard Routes
  {
    ...
    children: [
      ...
      {
        path: "/dashboard/admin/manualPayments",
        element: Lazy(AdminManualPayments),
      },
      {
        path: "/dashboard/admin/paymentSettings",
        element: Lazy(PaymentSettings),
      },
      {
